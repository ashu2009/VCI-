...
--nilにする時間
local nil_wait_timer_count = 1 / 2
--ディープ処理フラグ
...
--ディープに移る駒数
local change_deep_count = 8 * 8 - 25
--cpuメイン処理
...
function NormalEvaluate(board_pos, high, wide, w_bk_num)
    ...
    for high_pos = 1, #now_board_pos do
        ...
        for wide_pos = 1, #now_board_pos[high_pos] do
            ...
            --置くことのできる箇所か把握
            local return_data = PermissionPut(false, now_board_pos, high_pos, wide_pos, w_bk_num)
            if return_data.flg then
                put_permission_count = put_permission_count + 1
            end
        end
    ...
    count_num = count_num - put_permission_count
...
function aaa(board_pos, w_bk_num)
    local count_num = 0
    local est = (w_bk_num % 2 + 1)

    if board_pos[1][1] == w_bk_num then
        count_num = count_num + 15
    elseif board_pos[1][1] == est then
    ...
    if board_pos[6][3] == w_bk_num and board_pos[7][2] == w_bk_num and board_pos[8][1] == w_bk_num then
        count_num = count_num + 20
    elseif board_pos[6][3] == w_bk_num then
        count_num = count_num - 0.5
    end
...
function DeepEvaluate(board_pos, high, wide, w_bk_num)
    ...
    for high_pos = 1, #board_pos do
        ...
        for wide_pos = 1, #board_pos[high_pos] do
            if now_board_pos[high_pos][wide_pos] == w_bk_num then
                count_num = count_num + 1
            --elseif now_board_pos[high_pos][wide_pos] == est then
            --count_num = count_num - 1
            end
        end
    end
    ...
    elseif now_board_pos[1][1] == est then
        count_num = count_num - 15
    else
        NANAMEfunc5(board_pos, est)
        YOKOfunc5(board_pos, est)
        TATEfunc5(board_pos, est)

        if board_pos[1][2] == est then
            count_num = count_num + 2
        end
        if board_pos[2][2] == est then
            count_num = count_num + 2
        end
        if board_pos[2][1] == est then
            count_num = count_num + 2
        end
    end
    if now_board_pos[8][1] == w_bk_num then
        count_num = count_num + 10
    elseif now_board_pos[8][1] == est then
        count_num = count_num - 15
    else
        NANAMEfunc7(board_pos, est)
        YOKOfunc7(board_pos, est)
        TATEfunc7(board_pos, est)

        if board_pos[7][1] == est then
            count_num = count_num + 2
        end
        if board_pos[7][2] == est then
            count_num = count_num + 2
        end
        if board_pos[8][1] == est then
            count_num = count_num + 2
        end
    end
    if now_board_pos[1][8] == w_bk_num then
        count_num = count_num + 10
    elseif now_board_pos[1][8] == est then
        count_num = count_num - 15
    else
        NANAMEfunc6(board_pos, est)
        YOKOfunc6(board_pos, est)
        TATEfunc6(board_pos, est)

        if board_pos[1][7] == est then
            count_num = count_num + 2
        end
        if board_pos[2][7] == est then
            count_num = count_num + 2
        end
        if board_pos[2][8] == est then
            count_num = count_num + 2
        end
    end
    --
    if now_board_pos[8][8] == w_bk_num then
        count_num = count_num + 10
    elseif now_board_pos[8][8] == est then
        count_num = count_num - 15
    else
        NANAMEfunc8(board_pos, est)
        YOKOfunc8(board_pos, est)
        TATEfunc8(board_pos, est)

        if board_pos[8][7] == est then
            count_num = count_num + 2
        end
        if board_pos[7][7] == est then
            count_num = count_num + 2
        end
        if board_pos[7][8] == est then
            count_num = count_num + 2
        end
    end

    --角横
    if board_pos[1][3] == est and board_pos[1][2] == est and board_pos[1][1] == est then
        count_num = count_num - 15
    elseif board_pos[1][3] == w_bk_num then
        count_num = count_num + 1
    end

    if board_pos[1][6] == est and board_pos[1][7] == est and board_pos[1][8] == est then
        count_num = count_num - 15
    elseif board_pos[1][6] == w_bk_num then
        count_num = count_num + 1
    end

    if board_pos[8][3] == est and board_pos[8][2] == est and board_pos[8][1] == est then
        count_num = count_num - 15
    elseif board_pos[8][3] == w_bk_num then
        count_num = count_num + 1
    end

    if board_pos[8][6] == est and board_pos[8][7] == est and board_pos[8][8] == est then
        count_num = count_num - 15
    elseif board_pos[8][6] == w_bk_num then
        count_num = count_num + 1
    end
    ...
    --角縦
    if board_pos[3][1] == est and board_pos[2][1] == est and board_pos[1][1] == est then
        count_num = count_num - 15
    elseif board_pos[3][1] == w_bk_num then
        count_num = count_num + 1
    end

    if board_pos[3][8] == est and board_pos[2][8] == est and board_pos[1][8] == est then
        count_num = count_num - 15
    elseif board_pos[3][8] == w_bk_num then
        count_num = count_num + 1
    end

    if board_pos[6][1] == est and board_pos[7][1] == est and board_pos[8][1] == est then
        count_num = count_num - 15
    elseif board_pos[6][1] == w_bk_num then
        count_num = count_num + 1
    end

    if board_pos[6][8] == est and board_pos[7][8] == est and board_pos[8][8] == est then
        count_num = count_num - 15
    elseif board_pos[6][8] == w_bk_num then
        count_num = count_num + 1
    end
    ...
    --角ナナメ
    if board_pos[3][3] == est and board_pos[2][2] == est and board_pos[1][1] == est then
        count_num = count_num - 15
    elseif board_pos[3][3] == w_bk_num then
        count_num = count_num + 1
    end

    if board_pos[3][6] == est and board_pos[2][7] == est and board_pos[1][8] == est then
        count_num = count_num - 15
    elseif board_pos[3][6] == w_bk_num then
        count_num = count_num + 1
    end

    if board_pos[6][6] == est and board_pos[7][7] == est and board_pos[8][8] == est then
        count_num = count_num - 15
    elseif board_pos[6][6] == w_bk_num then
        count_num = count_num + 1
    end

    if board_pos[6][3] == est and board_pos[7][2] == est and board_pos[8][1] == est then
        count_num = count_num - 15
    elseif board_pos[6][3] == w_bk_num then
        count_num = count_num + 1
    end
    ...
    count_num = count_num - (put_permission_count * 0.1)

    cpu_count = cpu_count + 1
    return count_num
end

function YOKOfunc5(board_pos, w_bk_num)
    local count_num = 0
    local flg = false
    for i = 2, 7 do
        if board_pos[1][i] == w_bk_num then
...
function YOKOfunc6(board_pos, w_bk_num)
    local count_num = 0
    local flg = false
    for i = 7, 2, -1 do
        if board_pos[1][i] == w_bk_num then
...
function YOKOfunc7(board_pos, w_bk_num)
    local count_num = 0
    local flg = false
    for i = 2, 7 do
        if board_pos[8][i] == w_bk_num then
...
function YOKOfunc8(board_pos, w_bk_num)
    local count_num = 0
    local flg = false
    for i = 7, 2, -1 do
        if board_pos[8][i] == w_bk_num then
...
function TATEfunc5(board_pos, w_bk_num)
    local count_num = 0
    local flg = false
    for i = 2, 7 do
        if board_pos[i][1] == w_bk_num then
...
function TATEfunc6(board_pos, w_bk_num)
    local count_num = 0
    local flg = false
    for i = 2, 7 do
        if board_pos[i][8] == w_bk_num then
...
function TATEfunc7(board_pos, w_bk_num)
    local count_num = 0
    local flg = false
    for i = 7, 2, -1 do
        if board_pos[i][1] == w_bk_num then
...
function TATEfunc8(board_pos, w_bk_num)
    local count_num = 0
    local flg = false
    for i = 7, 2, -1 do
        if board_pos[i][8] == w_bk_num then
...
function NANAMEfunc5(board_pos, w_bk_num)
    local count_num = 0
    local flg = false
    for i = 2, 7 do
        if board_pos[i][i] == w_bk_num then
...
function NANAMEfunc6(board_pos, w_bk_num)
    local count_num = 0
    local flg = false
    for i = 2, 7 do
        if board_pos[i][9 - i] == w_bk_num then
...
function NANAMEfunc7(board_pos, w_bk_num)
    local count_num = 0
    local flg = false
    for i = 7, 2, -1 do
        if board_pos[i][9 - i] == w_bk_num then
...
function NANAMEfunc8(board_pos, w_bk_num)
    local count_num = 0
    local flg = false
    for i = 7, 2, -1 do
        if board_pos[i][i] == w_bk_num then
